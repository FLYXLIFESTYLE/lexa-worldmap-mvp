// ============================================================================
// LEXA Theme Categories - Neo4j Database Script with Real Unsplash Images
// ============================================================================

// STEP 1: Check existing theme categories
...
// ============================================================================
// STEP 2: Create/Update All 12 Theme Categories with High-Quality Images
// ============================================================================
...
SET t.description = "Where every moment is designed for connection",
    ...
    t.image_url = "https://images.unsplash.com/photo-1505881502353-a1986add3762?q=80&w=2400";
...
SET t.description = "For those who feel most alive on the edge",
    ...
    t.image_url = "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?q=80&w=2400";
...
SET t.description = "Deep restoration for body, mind, and soul",
    ...
    t.image_url = "https://images.unsplash.com/photo-1540555700478-4be289fbecef?q=80&w=2400";
...
SET t.description = "Where taste becomes memory",
    ...
    t.image_url = "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?q=80&w=2400";
...
SET t.description = "Experience the soul of a place",
    ...
    t.image_url = "https://images.unsplash.com/photo-1533929736458-ca588d08c8be?q=80&w=2400";
...
SET t.description = "Where 'too much' is just right",
    ...
    t.image_url = "https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&w=2400";
...
SET t.description = "Raw beauty that humbles and inspires",
    ...
    t.image_url = "https://images.unsplash.com/photo-1516426122078-c23e76319801?q=80&w=2400";
...
SET t.description = "Where the ocean becomes your playground",
    ...
    t.image_url = "https://images.unsplash.com/photo-1559827260-dc66d52bef19?q=80&w=2400";
...
SET t.description = "Beauty that moves the mind and soul",
    ...
    t.image_url = "https://images.unsplash.com/photo-1541961017774-22349e4a1262?q=80&w=2400";
...
SET t.description = "Memories that span generations",
    ...
    t.image_url = "https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?q=80&w=2400";
...
SET t.description = "Marking moments that matter",
    ...
    t.image_url = "https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?q=80&w=2400";
...
// ============================================================================
// STEP 3: Verify All Themes Were Created
// ============================================================================
...
// ============================================================================
// STEP 4: View All Themes with Details
// ============================================================================
