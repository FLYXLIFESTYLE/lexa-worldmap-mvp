 ...
 * Public user registration is disabled during beta.
 */
    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-12">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h2 className="mb-2 text-3xl font-bold text-white">Registration closed</h2>
          <p className="text-zinc-400">
            User accounts are invite-only during our beta.
          </p>
        </div>

        <div className="rounded-2xl bg-white/95 backdrop-blur-lg p-8 shadow-2xl border border-zinc-200/50 text-center">
          <p className="text-zinc-700">
            Request a personal demo to experience LEXA. We will set up access for you.
          </p>
          <div className="mt-6">
            <Link
              href="/"
