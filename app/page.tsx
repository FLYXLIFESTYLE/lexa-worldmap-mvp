      ...
      <main className="relative z-10 mx-auto max-w-5xl text-center">
        ...
        <div className="mb-8">
          <div className="relative inline-block">
            ...
            {/* Beta Badge on Logo */}
            <span className="absolute -top-2 -right-12 md:-right-20 inline-block px-3 py-1 rounded-full bg-lexa-gold text-zinc-900 text-xs md:text-sm font-bold tracking-wider shadow-lg shadow-lexa-gold/50 transform rotate-12">
              BETA
            </span>
          </div>
